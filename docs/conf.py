...
# -*- coding: utf-8 -*-
#
# jupyterlab_iex documentation build configuration file, created by
...
_version_py = os.path.join('..', 'jupyterlab_iex', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_iexdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_iex.tex', 'jupyterlab_iex Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_iex', 'jupyterlab_iex Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_iex', 'jupyterlab_iex Documentation',
     author, 'jupyterlab_iex', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_iex_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_iex'))
